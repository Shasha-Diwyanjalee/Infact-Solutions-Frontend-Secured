  ...
  function sendData(e) {
    ...
    if (password === cpassword) {
      axios
        ...
        .then(() => {
          toast.success("Admin Register Succesfull", {
        ...
        .catch((err) => {
          toast.warn(
            "Admin Account Already Exsist Check Email or Username again",
            { position: toast.POSITION.TOP_CENTER }
          );
        });
    } else {
                ...
                <form onSubmit={sendData}>
                  ...
                  <div className="mb-3 ml-5" style={{ marginBottom: "15px" }}>
                    ...
                    <input
                      ...
                      title="Sample Email - sample@gmail.com"
                      required="true"
                  ...
                  <div className="mb-3" style={{ marginBottom: "15px" }}>
                    ...
                    <input
                      ...
                      data-toggle="tooltip"
                      data-placement="center"
                      title="Username must be more than 6 characters"
                      onChange={(e) => {
                  ...
                  <div class="row">
                    <div class="col" style={{ marginBottom: "15px" }}>
                      ...
                      <input
                        ...
                        data-toggle="tooltip"
                        data-placement="center"
                        title="Password must contain at least 6 characters, including UPPER/lowercase and numbers Sample = 'Sample@523'"
                    ...
                    <div class="col" style={{ marginBottom: "15px" }}>
                      ...
                      <input
                        ...
                        data-toggle="tooltip"
                        data-placement="center"
                        title="Password must contain at least 6 characters, including UPPER/lowercase and numbers. Sample Password= 'Sample@523'"
                        pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9])(?!.*\s).{8,15}$"
                        required="true"
                        onChange={(e) => {

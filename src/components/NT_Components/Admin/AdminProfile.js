...
const Profile = () => {
  ...
  useEffect(() => {
    const getUserData = async () => {
      try {
        ...
        await axios
          .get("http://localhost:8070/admin/profile", config)
          .then((res) => {
  ...
  const deleteAdmin = async () => {
    ...
    if (window.confirm("Are you sure you wish to delete this Account?")) {
      await axios
        .delete("http://localhost:8070/admin/delete", config)
        .then((res) => {
          toast.success("Your account deleted successfuly", {
      ...
      <div class="container">
        <div class="main-body">
          <ul class="nav">
            ...
            <li>
              <a href="/add">Admin Registration</a>
            </li>
          </ul>
              ...
              <div class="shadow mb-3" id="cardcol">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">{description}</div>
                  </div>
                  <hr />
                  <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                      <center>
                        <button onClick={deleteAdmin} class="btn btn-primary">
                          Delete Account
                        </button>
                      </center>
                    </div>

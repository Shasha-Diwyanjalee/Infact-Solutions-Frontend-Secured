...
export default class DisplayDiscount extends Component {
  ...
  async generateReport() {
    ...
    await axios
      .post("http://localhost:8070/generateDiscountReport", obj, {
        ...
        <div className="shadow mb-4 w-55" id="cardcol">
          <div className="card-header py-3">
            ...
            <Button
              ...
              type="submit"
              style={{ background: "#B4CFEC", width: 15 + "%", align: "right" }}
            ...
            <Button
              className="form-group"
              type="submit"
              style={{ background: "#B4CFEC", width: 18 + "%", align: "right" }}
          ...
          <table
            ...
            style={{ marginTop: "40px", background: "#F0FFFF" }}
          >
            <thead>
              <tr bgcolor="#D5D6EA">
                <th scope="col">No</th>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <Button
                      ...
                      onClick={() => this.onDelete(discount._id)}
                    ></Button>
                  </td>
                </tr>
              ))}

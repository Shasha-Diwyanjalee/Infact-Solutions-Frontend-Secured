...
const SingleProductRequest = ({ itemname, brand, model, version, itemId }) => {
  ...
  const deleteRequest = async () => {
    ...
    await axios
      .delete(`http://localhost:8070/requests/delete/${itemId}`, config)
      .then((res) => {
  ...
  return (
    <div className="pb-2">
      ...
      >
        <h5 style={{ fontFamily: "Arial Black", color: "white" }}>
          {itemname}
        </h5>
        ...
        <div className="d-flex justify-content-end">
          <IconButton
            aria-label="edit"
            style={{ background: "#619dff", marginRight: 8 }}

...
export default class Home extends Component {
  ...
  async generateReport() {
    ...
    await axios
      .post("http://localhost:8070/generateadsreport", obj, {
        ...
        <div className="pt-0" align="center" background color="red">
          <div className="shadow col-md-11 mt-8 mx-auto" id="cardcol">
            <div className="card-header py-3">
              <h1 className="m-0 font-weight-bold text-dark" id="rs">
                {" "}
            ...
            <div className="container-sm">
              <div className="row">
                ...
                <Button
                  className="col-md-8 mt-4 mx-right"
                  type="submit"
                  style={{
                    background: "#B4CFEC",
                    width: 25 + "%",

...
export default class Home extends Component {
  ...
  onDelete = (productID) => {
    if (window.confirm("Are you sure you wish to delete this item?")) {
      axios
        .delete(`http://localhost:8070/products/delete/${productID}`)
        .then((res) => {
          //alert("Delete Successfully");
          toast.warning("Items Deleted Successfully", {
  ...
  filterData(products, searchKey) {
    const result = products.filter(
      (products) =>
        ...
        products.availability.toLowerCase().includes(searchKey)
    );
  ...
  async generateReport() {
    ...
    await axios
      .post("http://localhost:8070/generateproductreport", obj, {
  ...
  render() {
    return (
      <div className="card-header py-2">
        <div>
          <div className="row" style={{ background: "#368BC1" }}>
            <h3 align="center">
              <br />
              All Products Details
            </h3>
            <div className="col-lg-9 mt-2"></div>
            ...
            <div className="col-lg-3 mt-2 mb-2">
              ...
              <Button
                ...
                type="submit"
                style={{ background: "#E3E4FA", width: 50 + "%" }}
                startIcon={<InsertDriveFileIcon />}

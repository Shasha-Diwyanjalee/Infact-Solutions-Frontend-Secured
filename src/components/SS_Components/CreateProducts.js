...
export default class CreateProducts extends Component {
  ...
  containsInvalidCharacters = (inputValue, fieldName) => {
    const invalidCharactersPattern = /[^a-zA-Z0-9\s.-]+/;
    if (invalidCharactersPattern.test(inputValue)) {
  ...
  onSubmit = (e) => {
    ...
    const fieldsToCheck = [
      ...
      { value: originalTitle, name: "Original Title" },
      { value: productPrice, name: "Product Price" },
      { value: marketPrice, name: "Market Price" },
      { value: brandName, name: "Brand Name" },
      { value: warrantYear, name: "Warrant Year" },
    ...
    for (const fieldData of fieldsToCheck) {
      if (this.containsInvalidCharacters(fieldData.value, fieldData.name)) {
        return; 
      }
    }
  ...
  render() {
    return (
      <div align="center">
        <div
          className="card shadow mb-8 w-50"
          style={{ background: "#FFFFFF" }}
        >
          <div className="card-header py-3">
            <div class="card-header" style={{ background: "#E3E4FA" }}>
            ...
            <form className="row g-3">
              ...
              <div className="col-md-6">
                ...
                <select
                  className="form-control"
                  name="warrantYear"
                  placeholder="Enter Warrant Year"
                  value={this.state.warrantYear}
                  onChange={this.handleInputChange}
                  required
                >
              ...
              <div>
                <FileBase64
                  ...
                  name="coverImage"
                  multiple={false}
                  onDone={({ base64 }) => this.setState({ coverImage: base64 })}
                  required
                />
              </div>

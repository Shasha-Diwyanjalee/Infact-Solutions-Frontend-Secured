...
export default class CartPage extends Component {
  ...
  async componentDidMount() {
    ...
    await axios
      .get("http://localhost:8070/cart/display", config)
      .then((res) => {
  ...
  render() {
    return (
      ...
      //               <h5
      //                 className="text-color d-inline"
      //                 style={{ marginLeft: 280, color: "white" }}
      //               >
      //                 {this.state.cartItems.length}
      //               </h5>
      //               <h4
      //                 className="text-color pt-1"
      //                 style={{ marginRight: "18rem", color: "white" }}
      //               >
      //                 Total Price
      //               </h4>
      //               <h4
      ...
      //                 style={{ color: "white" }}
      //               >
      //                 LKR {this.state.totalPrice}.00
      //               </h4>
      //               <IconButton
      //                 size="small"
      //                 aria-label="add an alarm"
      //                 style={{ background: "#ff8c00", marginLeft: 225 }}
      //                 className="d-inline mb-2"
      //                 onClick={this.totalCal}
      //               >
      //                 <AutorenewIcon
      //                   style={{ background: "#ff8c00", marginRight: 30 }}
      //                 />
      //               </IconButton>
      //               &nbsp; &nbsp; &nbsp;
      //               <Button
      //                 variant="contained"
      //                 className="w-10"
      //                 style={{ background: "#ff8c00", width: 100 + "%" }}
      ...
      //                       className="generateReport1 btn btn-info btn-lg"
      //                       type="button"
      //                     >
      //                       <i class="fas fa-redo pr-2" aria-hidden="true"></i>{" "}
      //                       Download your Cart Details
      //                     </Button>
      //                   )}
                  ...
                  <div className="col-lg-4">
                    ...
                    >
                      ...
                      <IconButton
                        size="small"
                        aria-label="add an alarm"
                        style={{ background: "#ff8c00", marginLeft: 310, marginTop: 20 }}
                        className="d-inline mb-2"
                        onClick={this.totalCal}
                      >
                        <AutorenewIcon

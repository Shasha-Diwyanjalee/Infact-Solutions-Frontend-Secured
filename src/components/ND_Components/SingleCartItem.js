...
const SingleCartItem = ({
  ...
  const incrementQuantity = async () => {
    ...
    await axios
      .put(`http://localhost:8070/cart/update/${cartId}`, data, config)
      .then((res) => {
  ...
  const deleteItem = async () => {
    ...
    await axios
      .delete(`http://localhost:8070/cart/delete/${cartId}`, config)
      .then((res) => {
        console.log(res.data.status);
            ...
            <div className="row">
              ...
              <div className="col-lg-8">
                <div className="pl-lg-2">
                  ...
                  <h5 className="text-color" style={{ color: "white" }}>
                    LKR {price}.00
                  </h5>
                  ...
                  <AddIcon style={{ marginRight: 30}}/>
                    ...
                    &nbsp; &nbsp; &nbsp;
                    <h3
                      className="text-color font-weight-bold pt-lg-2 d-inline ml-5"
                      style={{ color: "white" }}
                    >
                      LKR {netValue}.00
                    </h3>
                  ...
                  <div className="d-flex justify-content-end">
                    {
                      <IconButton
                        ...
                        style={{ background: "#800000", marginLeft: 50 }}
                        className="d-inline"
                        onClick={deleteItem}
                      >

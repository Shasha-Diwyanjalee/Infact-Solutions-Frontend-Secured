...
export default class CheckOutPage extends Component {
  ...
  async componentDidMount() {
    ...
    await axios
      .get("http://localhost:8070/customer/profile", config)
      .then((res) => {
        this.setState({
  ...
  async submitCheckout(e) {
    ...
    await axios
      .post("http://localhost:8070/order/create", data, config)
      // .then((res) => {
      //   alert('success')
                ...
                >
                  <div className="col-12">
                    <div className="d-flex justify-content-center">
                      <h1 className="h3 text-color p-4">
                        Please Check Details Before Purchase
                      </h1>
                    </div>
                    <h3 className="text-color d-inline pl-5 font-weight-bold">
                      Total Price - LKR {this.state.totalPrice}.00
                    </h3>
                    <h5 className="text-color pl-5">
                      Number of Items - {this.state.cartItems.length}
                    </h5>
                    <form
                      className="user pl-5 pr-5 pb-5"
                    ...
                    >
                      ...
                      <div class="form-group">
                        ...
                        >
                          Add additional details if you want to
                        </label>
                        <textarea
                          class="form-control"
